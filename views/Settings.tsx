...
import { Sprout, Crown, User, Palette, Landmark, ShieldCheck, ArrowRight } from 'lucide-react';
    ...
    <div ref={registryRef} className="px-4 sm:px-6 md:px-12 py-8 sm:py-12 max-w-5xl mx-auto space-y-10 sm:space-y-12 animate-in fade-in duration-700">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 settings-stagger">
        ...
        <div className="w-full relative z-10">
            ...
            {(['profile', 'appearance', 'financials', 'compliance'] as const).map(tab => {
              const getIcon = () => {
                ...
                switch (tab) {
                  ...
                  case 'financials': return <Landmark className={iconClass} />;
                  case 'compliance': return <ShieldCheck className={iconClass} />;
                  default: return null;
                }
              };
              ...
              return (
                <button
                  ...
                  className={`flex-none px-5 sm:px-6 py-2.5 sm:py-2 rounded-xl sm:rounded-full text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2.5 whitespace-nowrap ${activeTab === tab
          ...
          {/* Mobile Swipe Hint */}
          <div className="flex md:hidden items-center gap-2 mt-4 ml-4 opacity-30 animate-pulse">
